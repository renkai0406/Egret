...
class Register extends UIWindow {

    public btn_getIdentity :   eui.Button;
    public btn_submit      :   eui.Button;
    public panel_first     :   eui.Panel;
    public panel_second    :   eui.Panel;
    private mainPanel       :   eui.Panel;
    public tinput_phone    :   eui.TextInput;
    public tinput_identify :   eui.TextInput;
    private tinput_name     :   eui.TextInput;
    ...
    private register_response_callback(msgSend : MessageBase, msgRec : MessageBase) : void{
